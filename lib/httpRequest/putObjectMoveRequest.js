 ...
 * this module rename an object in an bucket
 */
...
inherits(putObjectMoveRequest,httpRequest);

putObjectMoveRequest.prototype.setDestBucketName = function (destBucketName) {
    this.destBucketName = destBucketName;
}

putObjectMoveRequest.prototype.setDestObjectName = function (destObjectName) {
    this.destObjectName = encoder(destObjectName);
}

putObjectMoveRequest.prototype.setSourceBucketName = function (sourceBucketName) {
    this.sourceBucektName = sourceBucketName;
}

putObjectMoveRequest.prototype.setSourceObjectName = function (sourceObjectName) {
    this.sourceObjectName = encoder(sourceObjectName);
}

putObjectMoveRequest.prototype.sendRequest = function (func) {
    ...
    this.options.headers['x-nos-move-source'] = '/' + this.sourceBucektName + '/' + this.sourceObjectName;
...
module.exports = putObjectMoveRequest;